...
import { ResolversComposerMapping } from 'graphql-toolkit';
...
export declare type LogMethod = (message: string | Error) => void;
...
export declare const ModuleConfig: (module: string | GraphQLModule<any, any, any, Partial<{
    [key: string]: GraphQLScalarType | import("@kamilkisiela/graphql-tools").IEnumResolver | import("@kamilkisiela/graphql-tools").IResolverOptions<any, any, any> | (() => any) | Partial<import("@kamilkisiela/graphql-tools").IResolverObject<any, any, any>>;
}>> | ((module?: void) => string | GraphQLModule<any, any, any, Partial<{
    [key: string]: GraphQLScalarType | import("@kamilkisiela/graphql-tools").IEnumResolver | import("@kamilkisiela/graphql-tools").IResolverOptions<any, any, any> | (() => any) | Partial<import("@kamilkisiela/graphql-tools").IResolverObject<any, any, any>>;
}>>)) => symbol;
...
export declare class GraphQLModule<Config = any, Session extends object = any, Context = any, SelfResolvers extends Resolvers<any, ModuleContext<Context>> = Resolvers<any, ModuleContext<Context>>> {
    ...
    readonly schemaAsync: Promise<GraphQLSchema>;
    /**
     * Gets the application dependency-injection injector
     */
    readonly injector: Injector<Session>;
    readonly injectorAsync: Promise<Injector<Session>>;
    readonly extraSchemas: GraphQLSchema[];
    /**
     * Gets the merged GraphQL type definitions as one string
     */
    readonly typeDefs: DocumentNode;
    readonly typeDefsAsync: Promise<DocumentNode>;
    readonly resolvers: any;
    readonly resolversAsync: Promise<any>;
    readonly schemaDirectives: SchemaDirectives;
    private paramsOnOperationResult$Map;
    private opIdOnOperationCompleteResult$Map;
    readonly subscriptions: SubscriptionHooks;
    readonly selfDefaultProviderScope: ProviderScope;
    ...
    readonly selfTypeDefsAsync: Promise<DocumentNode>;
    readonly selfResolvers: SelfResolvers;
    readonly selfResolversAsync: Promise<SelfResolvers>;
    readonly selfImports: GraphQLModule<any, Session, any, Partial<{
        [key: string]: GraphQLScalarType | import("@kamilkisiela/graphql-tools").IEnumResolver | import("@kamilkisiela/graphql-tools").IResolverOptions<any, any, any> | (() => any) | Partial<import("@kamilkisiela/graphql-tools").IResolverObject<any, any, any>>;
    }>>[];
    readonly selfProviders: Provider[];
    readonly selfResolversComposition: ResolversComposerMapping;
    readonly selfSchemaDirectives: SchemaDirectives;
    ...
    readonly selfLogger: Logger;
    static defaultCache: KeyValueCache;
    readonly selfCache: KeyValueCache;
     ...
     */
    readonly context: (session: Session, excludeSession?: boolean, excludeInjector?: boolean) => Promise<ModuleContext<Context>>;
