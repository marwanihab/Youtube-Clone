import { mergeResolvers, composeResolvers, mergeSchemas, mergeSchemasAsync, getSchemaDirectiveFromDirectiveResolver, mergeTypeDefs, printSchemaWithDirectives } from 'graphql-toolkit';
import { Injector, ProviderScope } from '@graphql-modules/di';
import { GraphQLSchema, parse, GraphQLScalarType } from 'graphql';
...
export class GraphQLModule {
    ...
    get resolvers() {
        if (typeof this._cache.resolvers === 'undefined') {
            ...
            const composedResolvers = composeResolvers(mergeResolvers(resolversToBeComposed, {
                exclusions: this._exclusionsFromSchema
    ...
    _isScalarResolver(resolver) {
        return (resolver instanceof GraphQLScalarType ||
...
GraphQLModule.defaultCache = new InMemoryLRUCache();
